    ...
    <div class="leftside-menu">
        ...
        <div class="h-100" id="leftside-menu-container" data-simplebar>
            ...
            <ul class="side-nav">
                ...
                ?>
                <li class="side-nav-title side-nav-item"><?=$section['name']?></li>
                <?php
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    foreach ($breadcrumbs as $item) {
                                        ?>
                                        <li class="breadcrumb-item <?=$item['href']==='active'?'active':''?>"><?=$item['href']!=='active'?'<a href="'.$item['href'].'">'.$item['title'].'</a>':$item['title']?></li>
                                        <?php
                                    }
                                    ?>
                                </ol>
